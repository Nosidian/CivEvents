...
public class TierPrize {
    ...
    private void spawnChest(World world, Location location) {
        ...
        chestInventory.setItem(0, new ItemStack(Material.GOLDEN_APPLE, 1));
        chestInventory.setItem(1, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(2, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(3, new ItemStack(Material.GOLD_BLOCK, 1));
        chestInventory.setItem(4, new ItemStack(Material.DIAMOND_BLOCK, 1));
        chestInventory.setItem(5, new ItemStack(Material.GOLD_BLOCK, 1));
        chestInventory.setItem(6, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(7, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(8, new ItemStack(Material.GOLDEN_APPLE, 1));
        chestInventory.setItem(9, new ItemStack(Material.GOLDEN_APPLE, 1));
        chestInventory.setItem(10, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(11, new ItemStack(Material.GOLD_BLOCK, 1));
        chestInventory.setItem(12, new ItemStack(Material.DIAMOND_BLOCK, 1));
        chestInventory.setItem(13, new ItemStack(Material.ENCHANTED_GOLDEN_APPLE, 1));
        chestInventory.setItem(14, new ItemStack(Material.DIAMOND_BLOCK, 1));
        chestInventory.setItem(15, new ItemStack(Material.GOLD_BLOCK, 1));
        chestInventory.setItem(16, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(17, new ItemStack(Material.GOLDEN_APPLE, 1));
        chestInventory.setItem(18, new ItemStack(Material.GOLDEN_APPLE, 1));
        chestInventory.setItem(19, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(20, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(21, new ItemStack(Material.GOLD_BLOCK, 1));
        chestInventory.setItem(22, new ItemStack(Material.DIAMOND_BLOCK, 1));
        chestInventory.setItem(23, new ItemStack(Material.GOLD_BLOCK, 1));
        chestInventory.setItem(24, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(25, new ItemStack(Material.IRON_BLOCK, 1));
        chestInventory.setItem(26, new ItemStack(Material.GOLDEN_APPLE, 1));
    }
}