...
public class TierOne {
    ...
    private void spawnChest(World world, Location location) {
        ...
        chestInventory.setItem(1, new ItemStack(Material.STONE_SWORD, 1));
        chestInventory.setItem(5, new ItemStack(Material.APPLE, 1));
        chestInventory.setItem(11, new ItemStack(Material.IRON_INGOT, 1));
        chestInventory.setItem(16, new ItemStack(Material.BREAD, 1));
        chestInventory.setItem(22, new ItemStack(Material.STRING, 1));
        chestInventory.setItem(24, new ItemStack(Material.IRON_LEGGINGS, 1));
    }
}