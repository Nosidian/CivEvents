...
public class TierTwo {
    ...
    private void spawnChest(World world, Location location) {
        ...
        chestInventory.setItem(3, new ItemStack(Material.SHIELD, 1));
        chestInventory.setItem(8, new ItemStack(Material.DIAMOND, 1));
        chestInventory.setItem(11, new ItemStack(Material.CHAINMAIL_HELMET, 1));
        chestInventory.setItem(15, new ItemStack(Material.IRON_AXE, 1));
        chestInventory.setItem(18, new ItemStack(Material.GOLDEN_CARROT, 1));
        chestInventory.setItem(22, new ItemStack(Material.COOKED_BEEF, 1));
    }
}