...
public class PackageCommands implements CommandExecutor, TabCompleter {
    ...
    public PackageCommands(Plugin plugin, TierOne tierOne, TierTwo tierTwo, TierThree tierThree, TierFour tierFour, TierFive tierFive, TierPrize tierPrize) {
        this.plugin = plugin;
