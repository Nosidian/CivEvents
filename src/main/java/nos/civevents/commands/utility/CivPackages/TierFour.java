...
public class TierFour {
    ...
    private void spawnChest(World world, Location location) {
        ...
        chestInventory.setItem(3, new ItemStack(Material.CROSSBOW, 1));
        chestInventory.setItem(7, new ItemStack(Material.NETHERITE_BOOTS, 1));
        chestInventory.setItem(11, new ItemStack(Material.GOLDEN_APPLE, 2));
        chestInventory.setItem(17, new ItemStack(Material.ARROW, 10));
        chestInventory.setItem(18, new ItemStack(Material.LAVA_BUCKET, 1));
        chestInventory.setItem(23, new ItemStack(Material.NETHERITE_AXE, 1));
    }
}